...
export const CartApi = {
  ...
  updateItem: (itemId, payload) =>
    api.put(`/api/cart-items/${itemId}/`, payload),
...
export const PaymentsApi = {
  ...
  process: (paymentId, action) =>
    api.patch(`/api/payments/${paymentId}/process/`, { action })
};
...
export const ShipmentsApi = {
  ...
  deliver: (shipmentId, action) =>
    api.patch(`/api/shipments/${shipmentId}/deliver/`, { action })
};
